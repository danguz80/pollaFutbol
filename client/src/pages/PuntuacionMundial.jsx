...
export default function PuntuacionMundial() {
  ...
  const cargarReglas = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/mundial-puntuacion/reglas`, {
  ...
  const guardarCambios = async () => {
    try {
      ...
      await axios.put(
        `${API_URL}/api/mundial-puntuacion/reglas`,
  ...
  return (
    <div className="container mt-4 mb-5">
      <div className="text-center mb-4">
        <h1 className="display-6 fw-bold text-primary">🏆 Sistema de Puntuación - Mundial 2026</h1>
      ...
      <div className="card mt-4">
        <div className="card-body">
          ...
          <ul className="mb-0">
            ...
            <li className="text-primary fw-bold">Los puntos <strong>NO son acumulativos</strong>: solo se otorga la puntuación más alta. Si aciertas el resultado exacto (5 pts), solo obtienes 5 puntos, no se suman los puntos de diferencia ni signo.</li>
          </ul>
        </div>
      </div>
