...
export default function EstadisticasLibertadores() {
  ...
  const cargarEstadisticas = async () => {
    try {
      ...
      const responseReales = await axios.get(`${API_URL}/api/libertadores-estadisticas/estadisticas`);
      ...
      if (token) {
        ...
        const responsePronosticos = await axios.get(
          `${API_URL}/api/libertadores-clasificacion/pronosticos?usuario_id=${decoded.id}`,
            ...
            <div className="row g-3">
              <div className="col-12 col-md-4">
                <div className="d-flex align-items-center gap-2">
                  ...
                  <span className="small">Clasificados reales a Octavos</span>
                </div>
              </div>
              {usuario && (
                <div className="col-12 col-md-4">
                  <div className="d-flex align-items-center gap-2">
                    ...
                    <span className="small">Tus clasificados virtuales</span>
                  </div>
                </div>
              )}
