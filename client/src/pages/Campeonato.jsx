...
export default function Campeonato() {
  ...
  const subMenu = (
    <>
      {/* Hero Section con partidos destacados del Torneo Nacional */}
      <HeroSection competencia="torneo_nacional" />
      ...
      <div className="d-flex flex-wrap gap-2 justify-content-center my-4 sticky-top bg-white py-2 shadow-sm" style={{ zIndex: 1020 }}>
        ...
        <button className="btn btn-secondary" onClick={() => navigate("/resumen-jornada")}>📊 Resumen Jornada</button>
