...
export default function ResumenJornadaMundial() {
  ...
  useEffect(() => {
    ...
    if (usuario.activo_mundial !== true) {
      alert("⚠️ No tienes acceso al Mundial.");
      navigate("/");
      return;
    }
  }, []);
  ...
  const cargarResumen = async (numeroJornada) => {
    try {
      ...
      const response = await axios.get(
        `${API_BASE_URL}/api/mundial/resumen/jornada/${numeroJornada}`,
        { headers: { Authorization: `Bearer ${token}` } }
      );
  ...
  return (
    <div className="container-fluid mt-4 px-4">
      <h2 className="text-center mb-4">📊 Resumen de Jornada - Mundial 2026</h2>
              ...
              <div className="card shadow-sm">
                <div className="card-header bg-primary text-white">
                  <div className="d-flex align-items-center justify-content-between">
                    <h5 className="mb-0">
                      <img
                        src={getMundialLogoPorNombre(partido.nombre_local)}
                      ...
                      <img
                        src={getMundialLogoPorNombre(partido.nombre_visita)}
