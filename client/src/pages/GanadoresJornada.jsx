...
const Star = ({ children }) => (
  <span style={{ color: '#f7c948', marginLeft: 4, fontSize: isMobile ? '1em' : '1.3em', verticalAlign: 'middle', display: 'inline-block' }}>
    <svg width={isMobile ? 16 : 20} height={isMobile ? 16 : 20} viewBox="0 0 20 20" fill="currentColor" style={{ marginRight: 2, verticalAlign: 'middle' }}>
            ...
            <tr key={j.numero}>
              ...
              <td>
                {j.ganadores.map((g, idx) => (
                  <span key={g} style={{ marginRight: 12, fontWeight: 500 }}>
                    {g}
                    <Star />
