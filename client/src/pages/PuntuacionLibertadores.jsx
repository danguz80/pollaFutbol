...
export default function PuntuacionLibertadores() {
  ...
  const cargarReglas = async () => {
    try {
      ...
      const response = await axios.get(`${API_URL}/api/libertadores-puntuacion/reglas`, {
  ...
  const guardarCambios = async () => {
    try {
      ...
      await axios.put(
        `${API_URL}/api/libertadores-puntuacion/reglas`,
  ...
  const ordenFases = ['FASE DE GRUPOS', 'CLASIFICACIÓN', 'OCTAVOS', 'CUARTOS', 'SEMIFINALES', 'FINAL', 'CAMPEÓN'];

  return (
    <div className="container mt-4 mb-5">
      <div className="text-center mb-4">
        <h1 className="display-6 fw-bold text-danger">🏆 Sistema de Puntuación - Libertadores</h1>
